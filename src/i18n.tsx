...
const FR: Record<string, string> = {
  ...
  'Retail Price ($ USD)': 'Prix de vente ($ USD)',
  ...
  'e.g. 20% OFF or $15 OFF': 'Ex. -20% ou -15 $',
  ...
  'Exchange rate set to ${val} per point.': 'Taux de change fixé à {val} $ par point.',
  ...
  'points': 'points',
  'Est. Value: $X.XX USD': 'Valeur est. : $X.XX USD',
  '1 PT = $X': '1 PT = $X',
  ...
  'Avail: {n} PTS ($X)': 'Dispo : {n} PTS ({X} $)',
  'Redeem {n} PTS (worth $X) to get this treatment completely FREE!': 'Échangez {n} PTS (valant $X) pour ce soin entièrement GRATUIT !',
  ...
  'Use point balance cash-in: spend {n} PTS to get a direct -$X partial discount!': 'Utilisez votre solde : dépensez {n} PTS pour une remise partielle de -$X !',
