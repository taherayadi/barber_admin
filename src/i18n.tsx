...
const FR: Record<string, string> = {
  ...
  'Retail Price ($ USD)': 'Retail Price (TND)',
  ...
  'e.g. 20% OFF or $15 OFF': 'Ex. -20% ou -15 TND',
  ...
  'points': 'points',
  'Est. Value: $X.XX USD': 'Valeur est. : X.XX TND',
  '1 PT = $X': '1 PT = X TND',
  ...
  'Redeem {n} PTS (worth $X) to get this treatment completely FREE!': 'Échangez {n} PTS (valant X TND) pour ce soin entièrement GRATUIT !',
  ...
  'Use point balance cash-in: spend {n} PTS to get a direct -$X partial discount!': 'Utilisez votre solde : dépensez {n} PTS pour une remise partielle de -X TND !',
